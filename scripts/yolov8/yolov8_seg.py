...
from yolov8.utils import xywh2xyxy, nms, draw_mask_detections, sigmoid
...
class YOLOSeg:
    ...
    def draw_detections(self, image, draw_scores=True, mask_alpha=0.4):
        return draw_mask_detections(image, self.boxes, self.scores,
                               self.class_ids, masks_alpha)
